document.getElementById("submit2").onclick=function(){
	...
	if(document.getElementById('r11').checked || document.getElementById('r12').checked || document.getElementById('r13').checked || document.getElementById('r15').checked){
		document.getElementById("div3").innerHTML="Wrong!";
		document.getElementById("div3").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById('r16').checked || document.getElementById('r18').checked || document.getElementById('r19').checked || document.getElementById('r20').checked){
		document.getElementById("div4").innerHTML="Wrong!";
		document.getElementById("div4").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById('r21').checked || document.getElementById('r22').checked || document.getElementById('r23').checked || document.getElementById('r24').checked){
		document.getElementById("div5").innerHTML="Wrong!";
		document.getElementById("div5").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById("submit2").onclick){
...
document.getElementById("button").onclick=function(){
	if (document.getElementById('r1').checked && document.getElementById('r7').checked && document.getElementById('r14').checked && document.getElementById('r17').checked && document.getElementById('r25').checked) {
		window.open("final.html");
		}
	else{
		alert("You are not done yet because some of your answers are wrong!");
		}
}
