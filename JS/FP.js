document.getElementById("submit1").onclick=function(){
	...
	if(document.getElementById('r1').checked || document.getElementById('r3').checked || document.getElementById('r4').checked || document.getElementById('r5').checked){
		document.getElementById("div1").innerHTML="Wrong!";
		document.getElementById("div1").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById('r6').checked || document.getElementById('r7').checked || document.getElementById('r8').checked || document.getElementById('r10').checked){
		document.getElementById("div2").innerHTML="Wrong!";
		document.getElementById("div2").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById('r11').checked || document.getElementById('r12').checked || document.getElementById('r13').checked || document.getElementById('r14').checked){
	...
	if(document.getElementById('r22').checked || document.getElementById('r23').checked || document.getElementById('r24').checked || document.getElementById('r25').checked){
		document.getElementById("div5").innerHTML="Wrong!";
		document.getElementById("div5").setAttribute("style","color:   #da442d;");
	}
	if(document.getElementById("submit1").onclick){
...
document.getElementById("button").onclick=function(){
	if (document.getElementById('r2').checked && document.getElementById('r9').checked && document.getElementById('r15').checked && document.getElementById('r18').checked && document.getElementById('r21').checked) {
		window.open("FifthPage.html");
		}
	else{
